import {
  ...
  export function uiSetup(_gameMgr: GameManager) {
  ...
  function getPlayerCheckpoint() {
    return `Checkpoint: ${gameMgr.playerMgr.currentCheckpoint}`
  }